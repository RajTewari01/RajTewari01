<div align="center">
  ...
  <img src="https://komarev.com/ghpvc/?username=RajTewari01&label=Profile%20Views&color=blueviolet&style=for-the-badge" alt="Profile Views" />
...
class BiswadeepTewari:
    def __init__(self):
        self.name = "Biswadeep Tewari"
        self.role = "CSE Student @ MAKAUT"
        self.location = "Medinīpur, West Bengal, India"
        self.passions = [
            "Ethical Hacking 🔐",
            "Python Development 🐍", 
            "AI & Machine Learning 🤖",
        ...
        self.current_focus = "DSA & Penetration Testing"
    ...
    def current_mission(self):
        return {
            "learning": ["Data Structures", "Algorithms", "CyberSec"],
            "building": ["AI Tools", "Web Apps", "QR Solutions"],
            "exploring": ["Kali Linux", "Pen-testing", "CTF Challenges"]
        }
...
<div align="center">
  ...
  <br/><br/>
  <p><i>"I bridge the gap between Development & Security"</i></p>
</div>
...
<img src="https://user-images.githubusercontent.com/74038190/212284094-e50ddb5f-e8b1-4e2c-a525-021e428c5018.gif" width="100%">
...
│  🌐 Portfolio → biswadeep.pythonanywhere.com                  │
│  📱 Instagram → @light_up_my_world01                          │
│  💻 GitHub    → @RajTewari01                                  │
│                                                                │
...
### ⭐ If you like what you see, consider leaving a star on my repositories!
